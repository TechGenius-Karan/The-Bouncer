...
🔒 **Explicitly deprecated:** the earlier prototype's dark/nightclub *aesthetic* — deep aubergine + brass + velvet-rope visuals. Do not carry that specific palette/mood into art direction or iconography.

> **Revised 2026-08-25:** the original version of this note also blanket-restricted *verbal* bouncer/door theming (copy, naming), on the grounds that "The Bouncer" was a provisional title, not a creative brief. That blanket restriction is lifted — leaning into the door/bouncer metaphor in copy and light iconography (e.g. door illustrations, "walks in" / "turned away" language) is now welcome, as long as it stays inside the light/colorful/friendly mood locked above, not the deprecated dark aesthetic. The name itself is still provisional; this only relaxes how far copy/visuals can lean into the metaphor in the meantime.
...
- **Naming:** "The Bouncer" is still explicitly provisional, though copy/visuals are now free to lean into the door/bouncer metaphor (§5.1, revised 2026-08-25) rather than being restricted from it. Worth revisiting once the actual signature moment (§5.1, "card snaps into a bin") is prototyped — a rename might follow naturally from whatever metaphor wins, or the door/bouncer metaphor may simply stick given it's no longer off-limits.
