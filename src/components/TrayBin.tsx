    ...
    >
      ...
      <div className="relative h-16 w-full">
        {cards.map((c, n) => (
          <div
            key={c.id}
            className={`absolute left-1/2 flex h-[34px] w-[92%] -translate-x-1/2 animate-settle items-center justify-center rounded-[11px] border font-display text-[15px] font-bold tracking-wide ${isIn ? 'border-[#CDE4DD] text-bin-in-text' : 'border-[#F0DCC0] text-bin-out-text'} bg-slip`}
