 ...
 * with no natural parameter), hand-written semantic category rules, and the
 * parameterized families built from generated, coverage-checked data
 * (generatedRules.ts). The generated set is where taxonomy growth happens —
 * hand-writing rules one at a time is what left the game repeating a rule
