...
// writing to the `rules` Mongo collection (see
 ...
 * A subtletyOverride replaces the rule's static subtlety for
 * eligibility-window purposes only — evaluate() and every other property
 * are untouched.
 */
